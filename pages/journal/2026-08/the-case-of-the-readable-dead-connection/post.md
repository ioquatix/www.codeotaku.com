...
<svg viewBox="0 0 640 650" role="img" aria-labelledby="tls-layers-title tls-layers-description">
	...
	<rect class="diagram-node" x="60" y="50" width="520" height="110" rx="16"/>
	...
	<rect class="diagram-node" x="60" y="230" width="520" height="220" rx="16"/>
	<text class="diagram-heading" x="320" y="270">TLS decodes the pending record</text>
	
	<rect class="diagram-node diagram-node-positive" x="85" y="300" width="220" height="105" rx="12"/>
	<text class="diagram-code diagram-positive" x="195" y="335">application_data</text>
	...
	<rect class="diagram-node diagram-node-terminal" x="335" y="300" width="220" height="105" rx="12"/>
	<text class="diagram-code diagram-terminal" x="445" y="335">close_notify</text>
	<text class="diagram-text" x="445" y="367">clean TLS shutdown</text>
	<text class="diagram-muted" x="445" y="391">no HTTP bytes</text>
	
	<path class="diagram-connector diagram-connector-positive" d="M 195 300 L 195 165" marker-end="url(#tls-arrow-success)"/>
	<text class="diagram-label diagram-positive" x="206" y="205">response bytes</text>
	
	<path class="diagram-connector diagram-connector-terminal" d="M 445 300 L 445 190"/>
	<path class="diagram-connector diagram-connector-terminal" d="M 434 179 L 456 201 M 456 179 L 434 201"/>
	<text class="diagram-label diagram-terminal" x="456" y="205">EOF</text>
	
	<rect class="diagram-node" x="60" y="520" width="520" height="100" rx="16"/>
	...
	<path class="diagram-connector diagram-connector-accent" d="M 320 520 L 320 455" marker-end="url(#tls-arrow-neutral)"/>
